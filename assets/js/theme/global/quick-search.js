...
export default function () {
    ...
    const $quickSearchResultsDesktop = $('.desktop-search .quickSearchResults');
    ...
    const doSearch = _.debounce((searchQuery) => {
        utils.api.search.search(searchQuery, { template: 'search/quick-results' }, (err, response) => {
            ...
            $quickSearchResultsDesktop.show();
            $quickSearchResultsDesktop.addClass('search-activated');
            $('.searchloader').hide();
            const $quickSearchResultsCurrent = $quickSearchResults.filter(':visible');

            $('.desktop-search .search-close').click(function() {
