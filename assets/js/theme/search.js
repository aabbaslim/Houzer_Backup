...
export default class Search extends CatalogPage {
    ...
    showProducts(navigate = true) {
        ...
        if ($('#product-listing-container .productGrid').children().length > 0) {
...
$(document).ready(function () {
    var trigger = $('.suggestion-title')
    trigger.click(function() {
        $(this).toggleClass('categories-open');
        $(this).siblings('.category-suggestion-list').slideToggle(); 
    });
    ...
    function checkScreenSize(){
        ...
        if (newWindowWidth < 1024) {
            trigger.removeClass('categories-open');
            trigger.siblings('.category-suggestion-list').slideUp(); 
        } else {
            trigger.addClass('categories-open');
            trigger.siblings('.category-suggestion-list').slideDown(); 
        }
    }
});
